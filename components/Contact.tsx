          ...
          <div>
            ...
            <div className="space-y-4">
             ...
             <div className="flex gap-4">
              <a href="https://github.com/ricbarandog" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-slate-500 rounded-2xl flex items-center justify-center hover:bg-slate-700 transition-colors">
                <Github size={22} />
              </a>
