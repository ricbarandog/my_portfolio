          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-20">
            ...
            <div className="md:w-3/5 space-y-10 animate-fade-in-up">
              ...
              <p className="text-xl text-slate-500 max-w-xl leading-relaxed font-medium">
                I'm Ricardo, a <b>Tech Specialist</b> & <b>Virtual Assistant</b> specialized in automation, logistics software, and data storytelling. I make complex workflows simple with advanced prompt communication to harness AI's power for website creation.
              </p>
